...
export default function WhoWeAre() {
  ...
  const yParallaxReverse = useTransform(scrollYProgress, [0, 1], ["10%", "-10%"]);
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 left-0 w-full h-screen flex flex-col justify-start pt-20 md:pt-16 md:pb-16 z-20 pointer-events-none opacity-100 overflow-hidden">
      ...
      <div className="relative z-10 -mt-[100vh] pt-[20vh] md:pt-[22vh] md:pb-24">
        ...
        {/* =========================================
           ...
           ========================================= */}
        <div className="max-w-[1440px] mx-auto px-0 md:px-20 mb-0 md:mb-10 relative">
          <div className="flex flex-col md:flex-row items-start">
            
            {/* Image Container */}
            {/* MOBILE: h-auto (Let image decide height) | DESKTOP: Fixed h-[650px] */}
            <div className="w-full md:w-[50%] h-auto md:h-[650px] relative overflow-hidden z-0">
              <motion.div style={{ y: yParallax }} className="relative md:absolute inset-0 w-full h-full md:h-[120%]">
                 ...
                 {/* Fix for Blur & Crop:
                     1. Remove 'fill', use standard src to respect aspect ratio.
                     2. Class 'w-full h-auto' ensures full width.
                     3. 'sizes="100vw"' & 'quality={100}' ensures high-res load.
                 */}
                 <div className="block md:hidden w-full">
                   <Image 
                     src={whoWeareMobile} 
                     alt="Abstract Architecture Mobile"
        ...
        {/* =========================================
            SECTION 2: VISION 
           ========================================= */}
        <div className="max-w-[1440px] mx-auto px-0 md:px-0 md:mt-20 md:mb-10 relative">
           <div className="flex flex-col md:flex-row items-center md:justify-end">
            
              {/* Image Container */}
              {/* MOBILE: h-auto | DESKTOP: Fixed h-[650px] */}
              <div className="w-full md:w-[50%] h-auto md:h-[650px] relative overflow-hidden z-10 order-1 md:order-2">
                 <motion.div style={{ y: yParallaxReverse }} className="relative md:absolute inset-0 w-full h-full md:h-[120%]">
              ...
              <motion.div 
                ...
                className="w-full md:w-[60%] bg-white z-20 relative order-2 md:order-1 
                           px-6 py-12 md:p-16 
                           md:mx-0
                           mt-0 md:-mr-48 md:mt-24 md:ml-20 
                           text-left 
                           shadow-none"
              >
                 <h4 className="text-base font-regular font-open-sans uppercase tracking-[0.2em] text-gray-900 mb-6">
      ...
      <div id="section-founder" className="relative z-20 w-full bg-black text-white pt-0 md:pt-0">
        <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-16 items-center">
          ...
          <div className="md:col-span-5 bottom-0 relative group order-2 md:order-1 mt-0 md:mt-0">
            ...
            >
              ...
              {/* --- NAME LABEL OVERLAY --- */}
              <div className="absolute w-[85%] md:w-[70%] bottom-4 left-1/2 -translate-x-1/2 bg-black/40 px-4 py-3 flex items-center justify-between gap-10 border-l-2 border-white">
                 <div>
